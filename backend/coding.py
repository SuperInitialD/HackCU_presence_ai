...
PROBLEM_POOL = {
    "easy": [
        ...
        "binary-search", "contains-duplicate", "reverse-linked-list",
        "palindrome-number", "maximum-depth-of-binary-tree",
    ],
    "medium": [
        "longest-substring-without-repeating-characters", "three-sum",
        "container-with-most-water", "product-of-array-except-self",
        "maximum-subarray", "jump-game", "merge-intervals",
        "unique-paths", "coin-change", "word-search",
        "number-of-islands", "rotting-oranges", "course-schedule",
        "lowest-common-ancestor-of-a-binary-search-tree",
    ],
    "hard": [
        "median-of-two-sorted-arrays", "trapping-rain-water",
        "word-ladder", "merge-k-sorted-lists", "longest-valid-parentheses",
        "minimum-window-substring", "serialize-and-deserialize-binary-tree",
    ],
}
